                  ...
                  <table className="adm-table">
                    ...
                    <tbody>{[...filteredEnquiries].reverse().map(eq => (
                      <tr key={eq.id} className={eq.contacted ? 'row--contacted' : ''}>
                        ...
                        <td data-label="Actions"><div className="adm-row-actions"><a className="adm-whatsapp" href={`https://wa.me/91${String(eq.phone).replace(/\D/g,'')}?text=Hello%2C%20this%20is%20Shine%20High%20School%20Admissions.`} target="_blank" rel="noopener noreferrer"><MessageCircle size={14} /></a></div></td>
                      </tr>
                    ))}</tbody>
                  </table>
                </div>
